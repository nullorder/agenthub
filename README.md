...
Your plugin code stays in **your own repo**. You submit a PR that adds a reference to it in our `marketplace.json`. See [CONTRIBUTING.md](CONTRIBUTING.md) for the full guide.
